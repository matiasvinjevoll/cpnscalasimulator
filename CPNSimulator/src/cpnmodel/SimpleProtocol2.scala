...
object SimpleProtocol2 extends App {
  val net = CPNGraph()
  // Declarations
  ...
  // ########################################################################
  class Transmit[T, T0](ID1470769116: Place[T0, Multiset[T]], ID1470771631: Place[T0, Multiset[T]])(
    ...
    val compatible_ID1470773821 = (b1: BindingElement_ID1470773821, b2: BindingElement_ID1470773821) =>
      (b1.p == b2.p || b1.p == None || b2.p == None) &&
        (b1.success == b2.success || b1.success == None || b2.success == None)
    val merge_ID1470773821 = (b1: BindingElement_ID1470773821, b2: BindingElement_ID1470773821) => {
    ...
    val enumBindings_ID1470773821 = List(
      List(BindingElement_ID1470773821(None, Some(true)), BindingElement_ID1470773821(None, Some(false))))
    val ID1470773821 = Transition("ID1470773821", "Transmit", 1, compatible_ID1470773821, merge_ID1470773821, fullBindingElement_ID1470773821, guard_ID1470773821, enumBindings_ID1470773821)
    ...
    val ID1470775166 = Arc("ID1470775166", ID1470769116, ID1470773821, In)(eval_ID1470775166)
    net.addArc(ID1470775166)
    // Transmit ----> out
    val eval_ID1470775627 = (be: BindingElement_ID1470773821) => (be.success, be.p) match {
    ...
    val ID1470775627 = Arc("ID1470775627", ID1470771631, ID1470773821, Out)(eval_ID1470775627)
  ...
  // ########################################################################
  class Sender[T0, T1](ID1470848028: Place[T0, Multiset[Data]], ID1470848187: Place[T0, Multiset[Data]], ID1470848373: Place[T1, Multiset[Ack]])(
    implicit ev0: Multiset[Data] => Traversable[T0], ev1: Multiset[Ack] => Traversable[T1]) {
    val net = CPNGraph()
    // Places
    ...
    val compatible_ID1470848592 = (b1: BindingElement_ID1470848592, b2: BindingElement_ID1470848592) =>
      (b1.n == b2.n || b1.n == None || b2.n == None) &&
        (b1.k == b2.k || b1.k == None || b2.k == None)
    val merge_ID1470848592 = (b1: BindingElement_ID1470848592, b2: BindingElement_ID1470848592) => {
    ...
    val ID1470848592 = Transition("ID1470848592", "ReceiveAck", 2, compatible_ID1470848592, merge_ID1470848592, fullBindingElement_ID1470848592, guard_ID1470848592, enumBindings_ID1470848592)
    ...
    val ID1470851437 = Arc("ID1470851437", ID1470848832, ID1470848592, In)(eval_ID1470851437)
    ...
    val ID1470852878 = Arc("ID1470852878", ID1470848373, ID1470848592, In)(eval_ID1470852878)
    ...
    val ID1470852049 = Arc("ID1470852049", ID1470848832, ID1470848592, Out)(eval_ID1470852049)
    ...
    val compatible_ID1470849105 = (b1: BindingElement_ID1470849105, b2: BindingElement_ID1470849105) =>
      (b1.n == b2.n || b1.n == None || b2.n == None) &&
        (b1.d == b2.d || b1.d == None || b2.d == None)
    val merge_ID1470849105 = (b1: BindingElement_ID1470849105, b2: BindingElement_ID1470849105) => {
      val n = if (b1.n == None) b2.n else b1.n
    ...
    val ID1470849105 = Transition("ID1470849105", "Send Packet", 1, compatible_ID1470849105, merge_ID1470849105, fullBindingElement_ID1470849105, guard_ID1470849105, enumBindings_ID1470849105)
    ...
    val ID1470850012 = Arc("ID1470850012", ID1470848832, ID1470849105, In)(eval_ID1470850012)
    ...
    val eval_ID1470849388IN = (be: BindingElement_ID1470849105) => (be.n, be.d) match {
      case (Some(n), Some(d)) =>
        Data(n, d)
    }
    val ID1470849388IN = Arc("ID1470849388IN", ID1470848028, ID1470849105, In)(eval_ID1470849388IN)
    ...
    val ID1470850492 = Arc("ID1470850492", ID1470848832, ID1470849105, Out)(eval_ID1470850492)
    net.addArc(ID1470850492)
    // Send Packet ----> packets to send
    val eval_ID1470849388OUT = (be: BindingElement_ID1470849105) => (be.n, be.d) match {
      case (Some(n), Some(d)) =>
        Data(n, d)
    }
    val ID1470849388OUT = Arc("ID1470849388OUT", ID1470848028, ID1470849105, Out)(eval_ID1470849388OUT)
    net.addArc(ID1470849388OUT)
    // Send Packet ----> a
    val eval_ID1470853969 = (be: BindingElement_ID1470849105) => (be.n, be.d) match {
      case (Some(n), Some(d)) =>
        Data(n, d)
    }
    val ID1470853969 = Arc("ID1470853969", ID1470848187, ID1470849105, Out)(eval_ID1470853969)
  ...
  // ########################################################################
  class Receiver[T0, T1, T2](ID1470723480: Place[T0, Multiset[Data]], ID1470725592: Place[T1, Multiset[Ack]], ID1470734702: Place[T2, Multiset[String]])(
    implicit ev0: Multiset[Data] => Traversable[T0], ev1: Multiset[Ack] => Traversable[T1], ev2: Multiset[String] => Traversable[T2]) {
    val net = CPNGraph()
    // Places
    ...
    case class BindingElement_ID1470724324(
      ...
      d: Option[String],
      k: Option[Int]) extends BindingElement
    val compatible_ID1470724324 = (b1: BindingElement_ID1470724324, b2: BindingElement_ID1470724324) =>
      (b1.n == b2.n || b1.n == None || b2.n == None) &&
        (b1.d == b2.d || b1.d == None || b2.d == None) &&
        (b1.k == b2.k || b1.k == None || b2.k == None)
    val merge_ID1470724324 = (b1: BindingElement_ID1470724324, b2: BindingElement_ID1470724324) => {
      val n = if (b1.n == None) b2.n else b1.n
      val d = if (b1.d == None) b2.d else b1.d
      val k = if (b1.k == None) b2.k else b1.k
    ...
    val fullBindingElement_ID1470724324 = (be: BindingElement_ID1470724324) =>
      be.n != None &&
        be.d != None &&
        be.k != None
    val guard_ID1470724324_0 = EvalGuard((be: BindingElement_ID1470724324) => (be.n, be.k) match {
      case (Some(n), Some(k)) => {
        n.$bang$eq(k)
      }
    }, 0)
    ...
    val ID1470724324 = Transition("ID1470724324", "Discard Packet", 2, compatible_ID1470724324, merge_ID1470724324, fullBindingElement_ID1470724324, guard_ID1470724324, enumBindings_ID1470724324)
    ...
    val ID1470727987IN = Arc("ID1470727987IN", ID1470723819, ID1470724324, In)(eval_ID1470727987IN)
    ...
    val eval_ID1470726221 = (be: BindingElement_ID1470724324) => (be.n, be.d) match {
      case (Some(n), Some(d)) =>
        Data(n, d)
    }
    val ID1470726221 = Arc("ID1470726221", ID1470723480, ID1470724324, In)(eval_ID1470726221)
    net.addArc(ID1470726221)
    // Discard Packet ----> NextRec
    val eval_ID1470727987OUT = (be: BindingElement_ID1470724324) => (be.k) match {
      case (Some(k)) =>
        k
    }
    val ID1470727987OUT = Arc("ID1470727987OUT", ID1470723819, ID1470724324, Out)(eval_ID1470727987OUT)
    ...
    val ID1470732359 = Arc("ID1470732359", ID1470725592, ID1470724324, Out)(eval_ID1470732359)
    ...
    val compatible_ID1470725136 = (b1: BindingElement_ID1470725136, b2: BindingElement_ID1470725136) =>
      (b1.n == b2.n || b1.n == None || b2.n == None) &&
        (b1.a == b2.a || b1.a == None || b2.a == None) &&
        (b1.k == b2.k || b1.k == None || b2.k == None) &&
        (b1.d == b2.d || b1.d == None || b2.d == None) &&
        (b1.data == b2.data || b1.data == None || b2.data == None)
    val merge_ID1470725136 = (b1: BindingElement_ID1470725136, b2: BindingElement_ID1470725136) => {
      val n = if (b1.n == None) b2.n else b1.n
      val a = if (b1.a == None) b2.a else b1.a
      val k = if (b1.k == None) b2.k else b1.k
      val d = if (b1.d == None) b2.d else b1.d
      val data = if (b1.data == None) b2.data else b1.data
      new BindingElement_ID1470725136(n, a, k, d, data)
    }
    val fullBindingElement_ID1470725136 = (be: BindingElement_ID1470725136) =>
      be.n != None &&
        ...
        be.d != None &&
        be.data != None
    val guard_ID1470725136_0 = EvalGuard((be: BindingElement_ID1470725136) => (be.n, be.k) match {
      case (Some(n), Some(k)) => {
        n.$eq$eq(k)
      }
    }, 1)
    val guard_ID1470725136_1 = BindGuard((be: BindingElement_ID1470725136) => (be.k) match {
      case (Some(k)) =>
        val a = k.$plus(1)
        BindingElement_ID1470725136(be.n, Some(a), be.k, be.d, be.data)
    }, 2)
    val guard_ID1470725136 = List(guard_ID1470725136_0, guard_ID1470725136_1)
    val enumBindings_ID1470725136 = List()
    val ID1470725136 = Transition("ID1470725136", "Receive Packet", 3, compatible_ID1470725136, merge_ID1470725136, fullBindingElement_ID1470725136, guard_ID1470725136, enumBindings_ID1470725136)
    net.addTransition(ID1470725136)
    // ------------------ Arcs ------------------
    // NextRec ----> Receive Packet
    val pattern_ID1470730054_0 = Pattern((token: Any) => token match {
      case Tuple2(_, (k: Int)) =>
        BindingElement_ID1470725136(None, None, Some(k), None, None)
    }, 2)
    val eval_ID1470730054 = (be: BindingElement_ID1470725136) => (be.k) match {
      case (Some(k)) =>
        k
    }
    val ID1470730054 = Arc("ID1470730054", ID1470723819, ID1470725136, In)(eval_ID1470730054)
    net.addArc(ID1470730054)
    // b ----> Receive Packet
    val pattern_ID1470726893_0 = Pattern((token: Any) => token match {
      case Tuple2(_, Data((n: Int), (d: String))) =>
        BindingElement_ID1470725136(Some(n), None, None, Some(d), None)
    }, 1)
    val eval_ID1470726893 = (be: BindingElement_ID1470725136) => (be.n, be.d) match {
      case (Some(n), Some(d)) =>
        Data(n, d)
    }
    val ID1470726893 = Arc("ID1470726893", ID1470723480, ID1470725136, In)(eval_ID1470726893)
    ...
    val pattern_ID1470737284_0 = Pattern((token: Any) => token match {
      case Tuple2(_, (data: String)) =>
        BindingElement_ID1470725136(None, None, None, None, Some(data))
    }, 0)
    val eval_ID1470737284 = (be: BindingElement_ID1470725136) => (be.data) match {
      case (Some(data)) =>
        data
    }
    val ID1470737284 = Arc("ID1470737284", ID1470734702, ID1470725136, In)(eval_ID1470737284)
    net.addArc(ID1470737284)
    // Receive Packet ----> NextRec
    val eval_ID1470730942 = (be: BindingElement_ID1470725136) => (be.k) match {
      case (Some(k)) =>
        k.$plus(1)
    }
    val ID1470730942 = Arc("ID1470730942", ID1470723819, ID1470725136, Out)(eval_ID1470730942)
    net.addArc(ID1470730942)
    // Receive Packet ----> c
    val eval_ID1470733367 = (be: BindingElement_ID1470725136) => (be.a) match {
      case (Some(a)) =>
        Ack(a)
    }
    val ID1470733367 = Arc("ID1470733367", ID1470725592, ID1470725136, Out)(eval_ID1470733367)
    net.addArc(ID1470733367)
    // Receive Packet ----> received
    val eval_ID1470735543 = (be: BindingElement_ID1470725136) => (be.n, be.k, be.data, be.d) match {
    ...
    val ID1470735543 = Arc("ID1470735543", ID1470734702, ID1470725136, Out)(eval_ID1470735543)
    ...
    ID1470725136.orderedPatternBindingBasis = List(
      ...
      ArcPattern(ID1470730054, pattern_ID1470730054_0),
      guard_ID1470725136_1)
  }
  // ########################################################################
  // Generated code for module Network[A,B]
  // ########################################################################
  class Network[A, B, T0, T1](ID1470791644: Place[T0, Multiset[A]], ID1470793324: Place[T0, Multiset[A]], ID1470795031: Place[T1, Multiset[B]], ID1470796765: Place[T1, Multiset[B]])(
    implicit ev0: Multiset[A] => Traversable[T0], ev1: Multiset[B] => Traversable[T1]) {
    val net = CPNGraph()
    // Places
    // Wire modules
